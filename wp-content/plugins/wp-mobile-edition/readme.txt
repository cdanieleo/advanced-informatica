...
= DEMO =
* To see mTheme in action visit [This demo](http://fabrix.net/demo/).
* Look: Gallery page, Contact form, comments in levels, and all functionality like a theme for desktop.


= Translation =

* **Non-English Speaking Users** - Contribute a translation using the GlotPress web interface – no technical knowledge required ([how to](https://translate.wordpress.org/projects/wp-plugins/wp-mobile-edition)).
