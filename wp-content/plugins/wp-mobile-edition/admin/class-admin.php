...
//--------------------------------------------------------
        private $sbar_homepage       = 'https://wordpress.org/support/plugin/wp-mobile-edition';
        private $sbar_wpratelink     = 'http://wordpress.org/support/view/plugin-reviews/wp-mobile-edition?rate=5#postform';
        private $sbar_glotpress      = 'https://translate.wordpress.org/projects/wp-plugins/wp-mobile-edition';
